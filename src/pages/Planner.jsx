    ...
    >
      <div className="grid grid-cols-[32px_88px_170px_1fr_150px_160px] min-w-[750px] hover:bg-black/[0.01] transition-colors">
        ...
        <div className="flex flex-col items-center justify-center gap-2 py-2">
          ...
          >
            <CommentIcon />
            {photo.comments && <span className="absolute -top-0.5 -right-0.5 w-1.5 h-1.5 bg-blue-500 rounded-full" />}
          </button>
        </div>
      ...
      {showComments && (
        <div className="px-6 py-3 bg-blue-50/40 border-t border-blue-100">
          ...
          <textarea
            ...
            onChange={e => onFieldChange(photo.id, 'comments', e.target.value)}
